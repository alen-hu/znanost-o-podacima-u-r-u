...
description: "Ovo poglavlje obrađuje problem nedostajućih vrijednosti u analizi podataka. Razlikuju se eksplicitne nedostajuće vrijednosti označene s `NA` i implicitne nedostajuće vrijednosti koje nastaju kada određena opažanja uopće nisu prisutna u podacima, kao i posebna vrijednost `NaN` koja se pojavljuje kao rezultat matematički nedefiniranih operacija. Nadalje se prikazuju osnovni alati u R-u za prepoznavanje i provjeru prisutnosti nedostajućih vrijednosti te se objašnjavaju najčešći načini rada s njima."
